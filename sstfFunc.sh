...
#2014-2015
function runSSTF {
	echo -e "\nSSTF Simulation started" #echo all search seek access and blocks $1 = SSA $2 = BLOCKS
	...
	read padding #this is essentially used to buffer the time so the usage.db logs more than a few second
	sleep 1
	clear
}  
